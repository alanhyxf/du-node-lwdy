...
class InquiryBot extends Bot {
   ...
   constructor(postData) {
    ...
    launch() {
        ...
        listTemplate.setBackGroundImage('http://dbp-resource.gz.bcebos.com/e18a6c56-f4a0-56e9-3b3e-f2d778250855/bk1.jpg?authorization=bce-auth-v1%2Fa4d81bbd930c41e6857b989362415714%2F2018-11-14T00%3A31%3A26Z%2F-1%2F%2F39c617c36070c450942facc16b4ae119ccf9b9ebb52e7a8be7ffbb294b5a36b2');
        listTemplate.setTitle('国学经典');

        //设置模版列表数组listItems其中一项，即列表的一个元素
        let Item1 = new ListTemplateItem();
        Item1.setToken('book01');
        Item1.setImage('http://dbp-resource.gz.bcebos.com/e18a6c56-f4a0-56e9-3b3e-f2d778250855/book1.jpg?authorization=bce-auth-v1%2Fa4d81bbd930c41e6857b989362415714%2F2018-11-14T01%3A00%3A10Z%2F-1%2F%2F605dcdceae2b38620630b9323b80026ccf42fbd305ebdbcdc15284805bfe1200', 200, 200);
        Item1.setPlainPrimaryText('笠翁对韵');
        Item1.setPlainSecondaryText('国学经典启蒙');

        let Item2 = new ListTemplateItem();
        Item2.setToken('book02');
        Item2.setImage('http://dbp-resource.gz.bcebos.com/e18a6c56-f4a0-56e9-3b3e-f2d778250855/book2.jpg?authorization=bce-auth-v1%2Fa4d81bbd930c41e6857b989362415714%2F2018-11-14T01%3A00%3A10Z%2F-1%2F%2F74a35bd2f43221e5d87f8ab279b4a074e4a9744d22ae9dacf6f1744b9a61399a', 200, 200);
