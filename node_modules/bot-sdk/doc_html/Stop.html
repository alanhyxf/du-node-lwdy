...
<div id="main">
    ...
    <h1 class="page-title">Class: Stop</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Stop<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Stop 音频停止指令</div>
...
<article>
    ...
    <h4 class="name" id="Stop"><span class="type-signature"></span>new Stop<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="directive_AudioPlayer_Stop.js.html">directive/AudioPlayer/Stop.js</a>, <a href="directive_AudioPlayer_Stop.js.html#line26">line 26</a>
    </li></ul></dd>
    ...
    <ul>
        <li><a href="BaseDirective.html">BaseDirective</a></li>
    </ul>
